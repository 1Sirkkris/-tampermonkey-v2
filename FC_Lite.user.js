...
(() => {
  ...
  if (window.__fcrLite_v0151test) return;
  ...
  function paintResult(row, rawScan, product, matches, error = '') {
    ...
    sortCell.innerHTML = sort === '—'
      ? '—'
      : `<span class="sort-pill ${sort === 'FALSE' ? 'no' : 'yes'}" title="${sort === 'FALSE' ? 'Not sortable' : 'Sortable'}" aria-label="${sort === 'FALSE' ? 'Not sortable' : 'Sortable'}">${sort === 'FALSE' ? '🚫 NON-SORT' : '✓ SORTABLE'}</span>`;
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #fcratc-root.fcratc-tote-audit #fcratc-table { width:min(780px,100%); }
      #fcratc-root.fcratc-tote-audit .fcratc-meta { justify-content:flex-start; }
      #fcratc-root.fcratc-tote-audit .fcratc-status { margin-left:8px; }
      ...
      #fcratc-root.fcratc-tote-audit .fcratc-litebar {
        min-height:76px;
        gap:10px;
        padding:10px 12px;
        overflow:visible;
      }
      #fcratc-root.fcratc-tote-audit .fcratc-lite-brand { font-size:32px; }
      #fcratc-root.fcratc-tote-audit .fcratc-lite-sub { font-size:22.5px; }
      #fcratc-root.fcratc-tote-audit .fcratc-lite-container {
        padding:7px 12px;
        font-size:22px;
        white-space:nowrap;
      }
      #fcratc-root.fcratc-tote-audit .fcratc-core-status {
        min-height:42px;
        padding:6px 11px;
        display:inline-flex;
        align-items:center;
      ...
      #fcratc-root.fcratc-tote-audit .fcratc-top {
        min-height:72px;
        gap:8px;
        padding:6px;
      }
      ...
      #fcratc-root.fcratc-tote-audit .fcratc-btn {
        flex:0 0 60px;
        width:60px;
        height:60px;
        font-size:25px;
      ...
      #fcratc-root.fcratc-tote-audit .scan-code { font-size:30px; }
      ...
      #fcratc-root.fcratc-tote-audit .result-pill { font-size:24px; }
      #fcratc-root.fcratc-tote-audit #fcratc-table { width:min(1450px,100%); }
      #fcratc-root.fcratc-tote-audit #fcratc-table td:nth-child(1) { width:220px; }
      #fcratc-root.fcratc-tote-audit #fcratc-table td:nth-child(2) { width:220px; }
      #fcratc-root.fcratc-tote-audit #fcratc-table td:nth-child(4) { width:125px; }
      #fcratc-root.fcratc-tote-audit #fcratc-table td:nth-child(5) { width:250px; }
      #fcratc-root.fcratc-tote-audit .sort-pill {
        width:auto;
        min-width:180px;
        height:48px;
      ...
      #fcratc-root.fcratc-tote-audit .sort-pill.no {
        background:#9f1239;
        border-color:#701a35;
        color:#fff;
      }
      #fcratc-root.fcratc-tote-audit .sort-pill.yes {
        background:#166534;
        border:2px solid #14532d;
        color:#fff;
      }
      #fcratc-root.fcratc-tote-audit .dims-pill { max-width:none; }
      #fcratc-root.fcratc-tote-audit .bin-size {
        max-width:240px;
        padding:6px 10px;
      }
      ...
      #fcratc-root.fcratc-tote-audit #fcratc-table tr.missing td:first-child {
        box-shadow:inset 8px 0 0 #be123c;
      }
      #fcratc-root.fcratc-tote-audit #fcratc-table tr.missing td.result { background:#ffe4e6; }
      #fcratc-root.fcratc-tote-audit .fcratc-system-head {
        min-height:72px;
        gap:14px;
        padding:10px 14px;
      }
      #fcratc-root.fcratc-tote-audit .fcratc-system-title { font-size:30px; }
      #fcratc-root.fcratc-tote-audit .fcratc-system-caption { font-size:22px; }
      ...
      #fcratc-root.fcratc-tote-audit .fcratc-system-recheck {
        min-height:48px;
        padding:0 14px;
        font-size:22px;
        white-space:nowrap;
      }
      #fcratc-root.fcratc-tote-audit #fcratc-system-table { font-size:30px; }
      ...
      #fcratc-root.fcratc-tote-audit .fcratc-haz {
        min-height:40px;
        padding:0 10px;
        font-size:24px;
      }
      #fcratc-root.fcratc-tote-audit .fcratc-asin { font-size:30px; }
      ...
      #fcrlite-search {
        ...
        padding:0 10px;background:#fbfcfe;color:#172536;font-size:15px;font-weight:800;outline:none;
      }
      ...
      .fcrlite-go,.fcrlite-toggle-btn {
        ...
        background:#f8fafc;color:#172033;font-size:12.5px;font-weight:900;cursor:pointer;white-space:nowrap;
      }
      ...
      .fcrlite-toggles {
        ...
        margin-top:7px;padding:9px;border:1px solid #b8c5d2;border-radius:7px;background:#f6f8fb;
      }
      ...
      .fcrlite-card {
        overflow:visible;border:1px solid #c5d0da;border-radius:6px;background:#f7f9fb;
        box-shadow:0 1px 3px rgba(15,23,42,.055);
      }
      .fcrlite-card-head {
        display:flex;align-items:center;gap:8px;min-height:35px;padding:6px 10px;background:#d8e2ec;
        border-bottom:1px solid #b8c5d1;color:#10243a;font-size:15px;font-weight:900;letter-spacing:.01em;
      }
      ...
      .fcrlite-card-body { overflow-x:auto;overflow-y:visible;max-height:none;padding:9px;color:#172536;background:#f7f9fb;font-size:14px; }
      ...
      .fcrlite-card-body table { width:100%;border-collapse:collapse;font-size:14px;line-height:1.4; }
      .fcrlite-card-body th,.fcrlite-card-body td {
        padding:7px 9px;border:0;border-right:1px solid #dce3ea;border-bottom:1px solid #cbd5df;text-align:left;vertical-align:top;white-space:nowrap;
      }
      .fcrlite-card-body th {
        background:#dbe4ed;color:#10243a;border-right:1px solid #c5d0da;border-bottom:2px solid #afbdca;font-weight:900;
      }
      ...
      .fcrlite-card:not([data-endpoint="product"]) .fcrlite-card-body tbody tr:nth-child(odd) > td { background:#f8fafc; }
      .fcrlite-card[data-endpoint="inventory"] .fcrlite-card-body tbody tr:nth-child(even) > td,
      .fcrlite-card[data-endpoint="inventory-history"] .fcrlite-card-body tbody tr:nth-child(even) > td { background:#e2ebf4; }
      .fcrlite-card[data-endpoint="inventory"] .fcrlite-card-body tbody tr:hover > td,
      .fcrlite-card[data-endpoint="inventory-history"] .fcrlite-card-body tbody tr:hover > td { background:#cedfed; }
      ...
      .fcrlite-native-tools { display:flex;align-items:center;gap:8px;min-height:34px;padding:5px 8px;border-bottom:1px solid #d2dbe4;background:#f2f5f8; }
      ...
      .fcrlite-inventory-filter { width:245px;height:30px;padding:0 9px;border:1px solid #8f9ead;border-radius:6px;background:#fbfcfe;color:#172536;font:700 12.5px system-ui,-apple-system,"Segoe UI",Roboto,Arial,sans-serif;outline:none; }
  ...
  function buildSectionsUi() {
    ...
    function announceSectionRendered(def, search, serial, data) {
      try {
        window.dispatchEvent(new CustomEvent(SECTION_RENDERED_EVENT, {
    ...
    function renderSectionCard(def, card, data, search, rawInput, serial, requestGroup, range = {}) {
      ...
      announceSectionRendered(def, search, serial, data);
    }
