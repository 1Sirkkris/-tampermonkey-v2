...
| Sideline API Move | 0.3.6 | [Open](https://raw.githubusercontent.com/1Sirkkris/-tampermonkey-v2/main/Sideline_API_Move.user.js) |
...
| FCResearch → RIVER Ticket Assistant | 0.3.2 | Gate Hazmat N/A/L0 RIVER links until ASIN/FNSKU/title/PO/quantity/price/vendor are resolved, persist that payload, pause at the required manual step, then drive the approved option/W1/quantity/dropdown sequence to the final manual Create Issue page pending live validation. | [Open](https://raw.githubusercontent.com/1Sirkkris/-tampermonkey-v2/main/FCResearch_RIVER_Ticket_Assistant.user.js) |