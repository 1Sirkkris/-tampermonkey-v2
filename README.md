...
| --- | --- | --- | --- |
| AFT Super Overlay | 0.1.1 | One-tab adaptive Edit/Move mode launcher. Now remains visible on the AFT app-selection screen; it does not submit inventory actions. | [Open](https://raw.githubusercontent.com/1Sirkkris/-tampermonkey-v2/main/Diagnostics/AFT_Super_Overlay_TEST.user.js) |
