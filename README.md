...
| --- | --- | --- | --- |
| AFT Super Overlay | 0.4.1 | Immediate adaptive Edit/Move mode switcher using AFT's native selector. Checkmarks reflect AFT's confirmed mode; MoveItems modes remain distinct from the separate MoveContainer app. | [Open](https://raw.githubusercontent.com/1Sirkkris/-tampermonkey-v2/main/Diagnostics/AFT_Super_Overlay_TEST.user.js) |
