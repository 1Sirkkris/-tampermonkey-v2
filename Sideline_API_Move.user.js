...
(() => {
  ...
  registerRuntimeVersion('SIDELINE', VERSION);
...
`;
  ...
  if (ISS_CONSOLE_WORKER) {
    ...
    if (ISS_CONSOLE_LOCAL) workerBoot();
    else if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', workerBoot, { once:true });
    else workerBoot();
  } else {
